...
#
# Script generated by Vivado on Thu Nov 28 11:03:52 -0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : inverse_tb.sh
...
#
# Usage        : inverse_tb.sh
#                inverse_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inverse_tb.sh [-reset_run]
#                inverse_tb.sh [-reset_log]
#                inverse_tb.sh [-help]
#
...
#                script (type 'inverse_tb.sh -help' for more information).
#
...
# script info
echo -e "inverse_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inverse_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../ENEL/ 453/servo2/div_gen_0_tb.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inverse_tb xil_defaultlib.glbl -o inverse_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inverse_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inverse_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc inverse_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./inverse_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: inverse_tb.sh [-help]\n\
Usage: inverse_tb.sh [-step]\n\
Usage: inverse_tb.sh [-lib_map_path]\n\
Usage: inverse_tb.sh [-reset_run]\n\
Usage: inverse_tb.sh [-reset_log]\n\
Usage: inverse_tb.sh [-keep_index]\n\
Usage: inverse_tb.sh [-noclean_files]\n\n\
