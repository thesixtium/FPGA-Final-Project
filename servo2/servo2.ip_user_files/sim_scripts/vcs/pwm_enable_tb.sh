...
#                script (type 'pwm_enable_tb.sh -help' for more information).
#
...
compile()
{
  ...
  "../../../../../../ENEL/ 453/servo2/ikKeyboardControl.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwm_enable_tb xil_defaultlib.glbl -o pwm_enable_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwm_enable_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pwm_enable_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pwm_enable_tb_simv.daidir vcs_lib c.obj)
