...
#
# Script generated by Vivado on Mon Dec 02 22:08:53 -0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pwm_measure_tb.sh
...
#
# Usage        : pwm_measure_tb.sh
#                pwm_measure_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwm_measure_tb.sh [-reset_run]
#                pwm_measure_tb.sh [-reset_log]
#                pwm_measure_tb.sh [-help]
#
...
#                script (type 'pwm_measure_tb.sh -help' for more information).
#
...
# script info
echo -e "pwm_measure_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwm_measure_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../ENEL/ 453/servo2/keyboardControl.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm.sv" \
  "../../../../../../ENEL/ 453/servo2/receiver.sv" \
  "../../../../../../ENEL/ 453/servo2/top_level.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm_enable.sv" \
  "../../../../../../ENEL/ 453/servo2/inverse_kinematics.sv" \
  "../../../../../../ENEL/ 453/servo2/syncFIFO.sv" \
  "../../../../../../ENEL/ 453/servo2/clk_divider.sv" \
  "../../../../../../ENEL/ 453/servo2/divider.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm_measure.sv" \
  "../../../../../../ENEL/ 453/servo2/averager.sv" \
  "../../../../../../ENEL/ 453/servo2/fsm.sv" \
  "../../../../../../ENEL/ 453/servo2/fsm_controller.sv" \
  "../../../../../../ENEL/ 453/servo2/transmitter.sv" \
  "../../../../../../ENEL/ 453/servo2/display.sv" \
  "../../../../../../ENEL/ 453/servo2/clk_divider_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm_enable_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/syncFIFO_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/pwm_measure_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/divider_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/fsm_tb.sv" \
  "../../../../../../ENEL/ 453/servo2/inverse_kinematics_tb.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwm_measure_tb xil_defaultlib.glbl -o pwm_measure_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwm_measure_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pwm_measure_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pwm_measure_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_measure_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwm_measure_tb.sh [-help]\n\
Usage: pwm_measure_tb.sh [-step]\n\
Usage: pwm_measure_tb.sh [-lib_map_path]\n\
Usage: pwm_measure_tb.sh [-reset_run]\n\
Usage: pwm_measure_tb.sh [-reset_log]\n\
Usage: pwm_measure_tb.sh [-keep_index]\n\
Usage: pwm_measure_tb.sh [-noclean_files]\n\n\
