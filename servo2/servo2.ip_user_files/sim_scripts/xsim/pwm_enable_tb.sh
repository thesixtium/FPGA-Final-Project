...
#
# Script generated by Vivado on Thu Nov 28 09:14:11 -0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pwm_enable_tb.sh
...
#
# Usage        : pwm_enable_tb.sh
#                pwm_enable_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwm_enable_tb.sh [-reset_run]
#                pwm_enable_tb.sh [-reset_log]
#                pwm_enable_tb.sh [-help]
#
...
# script info
echo -e "pwm_enable_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwm_enable_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L xbip_pipe_v3_0_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_dsp48_addsub_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L floating_point_v7_0_23 -L xbip_dsp48_mult_v3_0_9 -L xbip_dsp48_multadd_v3_0_9 -L div_gen_v5_1_22 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot pwm_enable_tb xil_defaultlib.pwm_enable_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pwm_enable_tb -key {Behavioral:sim_1:Functional:pwm_enable_tb} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_0_23 xbip_dsp48_mult_v3_0_9 xbip_dsp48_multadd_v3_0_9 div_gen_v5_1_22)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pwm_enable_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_enable_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwm_enable_tb.sh [-help]\n\
Usage: pwm_enable_tb.sh [-step]\n\
Usage: pwm_enable_tb.sh [-lib_map_path]\n\
Usage: pwm_enable_tb.sh [-reset_run]\n\
Usage: pwm_enable_tb.sh [-reset_log]\n\
Usage: pwm_enable_tb.sh [-keep_index]\n\
Usage: pwm_enable_tb.sh [-noclean_files]\n\n\
